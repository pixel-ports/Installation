...
echo iptables -I INPUT 2 -i lo -j ACCEPT
...
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.23.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.24.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.25.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.26.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.27.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.28.1.200 -j DROP
echo iptables -I FORWARD '!' -s ${PUBLIC_HOST_IP} -p tcp --dport 80 -d 172.29.1.200 -j DROP
echo
echo "  / \\"
echo " / | \\"
echo "/  *  \\"
