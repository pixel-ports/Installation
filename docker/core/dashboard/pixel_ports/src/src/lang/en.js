export default {
  ...
  common: {
    ...
    removeCargoCategory: 'Confirm to remove the cargo category?',
    deleteCargoCategory: 'Delete Cargo Category',
    removeShiftWork: 'Confirm to remove the Shiftwork?',
    deleteShiftWork: 'Delete Shiftwork',
    ...
    stepsNotImplemented: 'No steps available. Please review your object.',
    SC_NameNotImplemented: 'No Supplier Chain Name provided. Please review your object.',
    ...
    cargoCategoryNotImplemented: 'No Cargo category available. Please review your object',
    shiftWorkNotImplemented: 'No Shiftwork available. Please review your object',
    ...
    filter: 'Filter',
    messageNoShiftWork: 'There is no record of ShiftWork. To register the machines you must first have shiftworks registered. Please go to the rules/shiftwork form.',
    ...
    messageNoCreateCompatibility: 'It is not possible to register a compatibility record. Check that you have registers for: Areas, CargoCategory and ShiftWork.',
    compatibilityRelatedToShiftWork: 'You cannot delete the record. There is a Compatibility register related to this ShiftWork.',
    ...
    mustExistSupplierChain: 'A Supplier Chain must exist in order to register a Cargo Category. Please, go to Supplier Chain menu and create an empty Supplier Chain.',
    supplierChainRelatedToCargoCategory: 'It is not possible to delete this record. It is related to a Cargo Category (Rules).',
    ...
    noCargoCategoriesCreated: 'There are NO Cargo Category records.',
    ...
    noValidNameForCargoCategory: 'You can not register the Cargo Category with this ID. There is already another record with the same ID.',
    noValidNameForShiftWork: 'You can not register the ShiftWork with this ID. There is already another record with the same ID.',
  ...
  area: {
    ...
    areaID: 'Area ID:',
    shiftwork_ID: 'ShiftWork ID:',
    rules: 'Rules',
    cargoCategories: 'Cargo Category',
    segment: 'Segment:',
  ...
  supplierChain: {
    ...
    steps: 'Steps',
    start: 'Start',
    cargoes_category: 'Cargoes Category:',
    cargoes_categoryHeader: 'Cargoes Category',
    directions_Nature: 'Directions Nature:',
    directions_NatureHeader: 'Directions Nature',
    areas_ID: 'Areas ID:',
    areas_IDHeader: 'Areas ID',
    shiftworks_ID: 'Shiftworks ID:',
    shiftworks_IDHeader: 'Shiftworks ID',
    duration: 'Duration',
    nature: 'Nature',
    nature_: 'Nature:',
    value: 'Value',
    ...
    selectCargoesCategory: 'Select Cargoes Category',
    selectAreas_ID: 'Select Areas ID',
    selectShifworks_ID: 'Select Shiftwork ID',
  ...
  rules: {
    ...
    btnAddShiftWork: 'Add Shift Work',
    btnAddCargoCategory: 'Add Cargoes Category',
    search: 'search',
    ruleName: 'Name',
    description: 'Description',
    description_: 'Description:',
    ...
    name: 'Name',
    name_: 'Name:',
    cargo_category: 'Cargoes Category',
    shiftwork: 'Shiftwork',
    priority: 'Priority',
    priority_: 'Priority:',
    ...
    createCargoesCategory: 'Create Cargoes Category',
    createShiftWork: 'Create Shift Work',
    editCargoesCategory: 'Edit Cargoes Category',
    editShiftWork: 'Edit Shift Work',
    ...
    cargo_categoryHeader: 'CARGOES CATEGORY',
